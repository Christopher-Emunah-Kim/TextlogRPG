...
int main()
{
	...
	while (!isGameStart)
	{
		...
		//메인 메뉴 출력
		cout << "=========================================" << endl;
		cout << "1. ??? 뭐가 뭔진 모르겠지만 일단 해보죠." << endl;
		...
		if (choice == 1 || choice == 2)
		{
			...
			case 1:
				system("cls");
				cout << "\n\n좋아. 자네는 이제부터 이곳에서 살아남아야 하네." << endl; 
				Sleep(2000);
				cout << "\n\n어디한번. 잘해보게나. 클클클...." << endl;
				Sleep(2000);
			...
			case 2:
				system("cls");
				cout << "\n\n자네는 정말로 그만두고 싶나? 자네가 이곳을 떠나면 자네는 영원히 이곳에 돌아올 수 없게 되네." << endl;
				Sleep(2000);
				cout << "\n\n정말로 그만두겠나? \n\n (1: 예, 2: 아니오) ";
				int exitChoice;
				cin >> exitChoice;
				...
				{
					cout << "\n\n좋아. 자네는 계속 이곳에 남기로 했군. 자, 이제 어떻게 하겠나?" << endl; 
					Sleep(4000);
					continue;
				}
				else
	...
	cout << "\n\n[System] 당신의 여정이 평안하길" << endl; Sleep(3000);
	...
	while (true)
	{
		system("cls");
		//플레이어가 입력한 명령어를 받음
		cout << "\n\n자, 이제 어떻게 하면 좋을까?" << endl; Sleep(3000);
		cout << "=========================================" << endl;
		cout << "\n1. 동쪽으로 이동한다." << endl;
		cout << "\n2. 서쪽으로 이동한다." << endl;
		cout << "\n3. 남쪽으로 이동한다." << endl;
